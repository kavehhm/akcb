    ...
    <header className=" font-inter">
      ...
      >
        ...
        <div className="hidden lg:gap-x-8 text lg:flex lg:flex-1 lg:justify-end">
          <Link href="https://discord.gg/4v2FfNwE" className="text-4xl text-purp hover:scale-105 transition">
            <BsDiscord />
          </Link>
          <Link href="https://twitter.com/beast96436?t=PdUlVXQ13yxaZaE1LgdVvw&s=09" className="text-4xl text-purp hover:scale-105 transition">
            <AiOutlineTwitter />
          </Link>
          <Link href="#" className="text-4xl text-gray-400 cursor-not-allowed">
            <SiOpensea />
          </Link>
        </div>
      </nav>
